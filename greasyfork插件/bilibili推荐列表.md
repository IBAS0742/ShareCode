...
<div class="clear-my-panel" id="clear-my-panel">清空列表</div>`;
        ...
        getNextPage() {
            ...
            fetch(`https://api.bilibili.com/x/web-interface/index/top/rcmd?fresh_type=3&version=1&ps=10&fresh_idx=${this.timer}&fresh_idx_1h=${this.timer}`,{
                method: 'get',
                credentials: 'include'
            })
                .then(_ => _.json())
